...
{
    private static ResourceLocation loc = new ResourceLocation(MineFactoryReloadedCore.tileEntityFolder + "redcomp.png");
	private static ResourceLocation loc2 = new ResourceLocation(MineFactoryReloadedCore.tileEntityFolder + "cards.png");
