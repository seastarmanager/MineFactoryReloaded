...
public class ItemXpExtractor extends ItemFactory
{
	...
	{
		_icon1 = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".1");
		_icon2 = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".2");
		_icon3 = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".3");
