...
public class ItemSafariNet extends ItemFactory
{
	...
	{
		_iconEmpty = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".empty");
		_iconBack = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".back");
		_iconMid = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".mid");
		_iconFront = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".front");
