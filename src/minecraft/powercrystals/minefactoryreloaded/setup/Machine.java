...
public class Machine
{
	...
	{
		_iconsActive[0] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".active.bottom");
		_iconsActive[1] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".active.top");
		_iconsActive[2] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".active.front");
		_iconsActive[3] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".active.back");
		_iconsActive[4] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".active.left");
		_iconsActive[5] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".active.right");
		_iconsIdle[0] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".idle.bottom");
		_iconsIdle[1] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".idle.top");
		_iconsIdle[2] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".idle.front");
		_iconsIdle[3] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".idle.back");
		_iconsIdle[4] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".idle.left");
		_iconsIdle[5] = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getInternalName() + ".idle.right");
	}
