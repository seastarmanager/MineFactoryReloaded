...
public class GrindingDamage extends DamageSource
{
    ...
    public ChatMessageComponent getDeathMessage(EntityLivingBase par1EntityLiving)
    {
        ...
        String s1 = s + ".player";
        return entityliving1 != null && StatCollector.func_94522_b(s1) ? ChatMessageComponent.createFromText(StatCollector.translateToLocalFormatted(s1, par1EntityLiving.getTranslatedEntityName(), entityliving1.getTranslatedEntityName())) : ChatMessageComponent.createFromText(StatCollector.translateToLocalFormatted(s, par1EntityLiving.getTranslatedEntityName()));
    }
}