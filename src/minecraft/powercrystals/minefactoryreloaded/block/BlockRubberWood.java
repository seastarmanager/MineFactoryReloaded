...
public class BlockRubberWood extends BlockLog implements IConnectableRedNet {
    ...
    public void registerIcons(IconRegister ir) {
        _iconLogSide = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".side");
        _iconLogTop = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".top");
    }
