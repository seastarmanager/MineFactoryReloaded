...
public class BlockRubberLeaves extends BlockLeaves implements IConnectableRedNet
{
	...
	{
		_iconOpaque = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".opaque");
		_iconTransparent = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".transparent");
	}
