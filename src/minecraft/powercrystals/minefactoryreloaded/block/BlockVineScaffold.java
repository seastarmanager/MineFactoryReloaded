...
public class BlockVineScaffold extends Block {
    ...
    public void registerIcons(IconRegister ir) {
        _sideIcon = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".side");
        _topIcon = ir.registerIcon(MineFactoryReloadedCore.modId + ":" + getUnlocalizedName() + ".top");
    }
