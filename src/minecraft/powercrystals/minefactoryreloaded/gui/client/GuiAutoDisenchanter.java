...
public class GuiAutoDisenchanter extends GuiFactoryPowered {
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.id == 1) {
            ...
            PacketDispatcher.sendPacketToServer(NetworkHandler.getBuilder().startBuild(_disenchanter.xCoord, _disenchanter.yCoord, _disenchanter.zCoord)
                                                                            .append(_disenchanter.getRepeatDisenchant() ? 1 : 0).build());
