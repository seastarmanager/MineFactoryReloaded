...
public class GuiBioReactor extends GuiFactoryInventory
{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		if(_tileEntity.getTank() != null && _tileEntity.getTank().getFluid() != null)
		{
			...
			drawTank(132, 75, tankSize, _tileEntity.getTank().getFluid()); // Fluid.itemMeta
		}
	...
	{
		if(isPointInRegion(132, 15, 16, 60, mouseX, mouseY) && _tileEntity.getTank() != null && _tileEntity.getTank().getFluid() != null && _tileEntity.getTank().getFluidAmount() > 0)
		{
