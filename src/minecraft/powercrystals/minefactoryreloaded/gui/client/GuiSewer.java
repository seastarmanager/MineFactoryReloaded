...
public class GuiSewer extends GuiFactoryInventory {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (_tileEntity.getTank() != null && _tileEntity.getTank().getFluid() != null) {
            ...
            drawTank(152, 75, tankSize, _tileEntity.getTank().getFluid());
        }
    }

    @Override
    protected void drawTooltips(int mouseX, int mouseY) {
        if (isPointInRegion(152, 15, 16, 60, mouseX, mouseY) && _tileEntity.getTank() != null && _tileEntity.getTank().getFluid() != null && _tileEntity.getTank().getFluidAmount() > 0) {
