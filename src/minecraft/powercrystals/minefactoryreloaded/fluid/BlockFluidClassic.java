package powercrystals.minefactoryreloaded.fluid;
...
public class BlockFluidClassic extends BlockFluidBase
{
    ...
    public BlockFluidClassic(int id, Fluid fluid, Material material, String unlocalizedName)
    {
        super(id, fluid, material);
        FluidRegistry.registerFluid(fluid.setUnlocalizedName(unlocalizedName).setBlockID(this).setStillIcon(getIcon(1, 0)).setFlowingIcon(getIcon(2, 0)));
    ...
    public void _setUnlocalizedName(String s) {
        super.setUnlocalizedName(s);
    }

    public void _setHardness(float f) {
        super.setHardness(f);
    }

    public void _setLightOpacity(int i) {
